...
import { deleteUserHistory, DeleteUserHistory } from './deleteUserHistory'
...
export class ChatHelper {
	...
	async deleteUserHistory(props: DeleteUserHistory) {
		return await deleteUserHistory(this.client, props)
	}
